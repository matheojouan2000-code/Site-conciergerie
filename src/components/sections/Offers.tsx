    ...
    <section id="offres" className="bg-cream-100 py-20 lg:py-28">
      <div className="mx-auto max-w-6xl px-5 lg:px-8">
        <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1">
          ...
          <p className="text-forest-900/60">Nous avons l'offre qui vous convient</p>
        </div>
        ...
        <div className="mt-10 grid grid-cols-1 gap-8 lg:grid-cols-5 lg:gap-12">
          <div className="rounded-xl bg-gold-gradient p-8 text-white lg:col-span-2">
            ...
            <div className="mt-4 rounded-lg bg-forest-950/20 p-4 text-sm">
              Notre réussite dépend de la vôtre : nous ne gagnons que si vous gagnez.
            </div>
          </div>

          <div className="lg:col-span-3">
            <h3 className="font-display text-xl font-semibold text-forest-950">Nos services inclus</h3>
